...
**Hero example**：
你想用 DeepSeek-R2（2026-03 release、前身 R1 開源 reasoning lineage）寫 code（比 Claude Opus 便宜 10×）。Aider 設 `--model deepseek/deepseek-reasoner` + `OPENROUTER_API_KEY` 就能跑、git-aware、commit message 自動寫。
